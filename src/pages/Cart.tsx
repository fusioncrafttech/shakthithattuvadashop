...
export function Cart() {
  ...
  return (
    ...
    >
      ...
      <div className="fixed bottom-20 left-0 right-0 z-[60] border-t border-gray-200 bg-white px-4 py-4 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] md:static md:bottom-auto md:mt-10 md:rounded-2xl md:border md:border-gray-100 md:px-6 md:py-6 md:shadow-lg">
        <div className="mx-auto flex max-w-3xl items-center justify-between gap-4">
          <div className="min-w-0">
            <p className="text-xs text-gray-500 md:text-sm">{t('cart.total')}</p>
          ...
          <button
            ...
            className="shrink-0 rounded-xl bg-[#E53935] px-6 py-3.5 text-center font-semibold text-white shadow-lg hover:bg-[#C62828] transition-colors active:scale-[0.98] md:px-8 cursor-pointer"
          >
            {t('cart.checkout')}
          </button>
        </div>

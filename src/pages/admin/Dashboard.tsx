...
export function AdminDashboard() {
  ...
  if (!stats) {
    return (
      <div className="flex flex-col items-center justify-center rounded-3xl border border-red-100 bg-red-50 p-12 text-center text-red-600">
        <svg className="mb-4 h-12 w-12 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
        </svg>
        <h2 className="text-xl font-bold">Failed to load dashboard</h2>
        <p className="mt-2 text-sm text-red-500">There was a problem retrieving data or you do not have permission.</p>
        <button
          onClick={() => window.location.reload()}
          className="mt-6 rounded-xl bg-red-600 px-6 py-2.5 font-medium text-white shadow-sm transition hover:bg-red-700 active:scale-95"
        >
          Retry
        </button>
      </div>

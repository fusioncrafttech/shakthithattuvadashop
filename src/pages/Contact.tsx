...
export function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await emailjs.send(
        'service_h09rktf', // e.g., 'service_xxxxx'
        'template_tylm65f', // e.g., 'template_xxxxx'
        {
          from_name: form.name,
          mobile_number: form.mobile,
          message: form.message,
        },
        'ffIR_wLr6XXU2vBOG' // e.g., 'xxxxxxx'
      );
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                className="w-full rounded-2xl bg-primary py-4 font-semibold text-white shadow-lg shadow-primary/25 transition-all duration-300 hover:bg-primary-dark hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-70 disabled:cursor-not-allowed"
